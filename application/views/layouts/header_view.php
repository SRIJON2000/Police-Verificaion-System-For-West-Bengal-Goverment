...
<div class="header row" id="header_body">
  ...
  <div class="mt-3 p-3 m-xs-0 row" id="header_body" style="background-color:black;height:80px">
    <div class="col-lg-1 col-sm-4"><a class="btn text-center" style="color:white" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'" href="http://localhost/pvr/" <?php if ($_SERVER['PHP_SELF']=='/pvr/index.php/test/dashboard_admin'){echo 'target="_blank"';};?>><b>Home</b></a></div>
    <div class="col-lg-1 col-sm-3" ><a class="btn text-center" style="color:white" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='white'" href="<?php echo base_url(); ?>/Home/contact"><b>Contact</b></a></div>
