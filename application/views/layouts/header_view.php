...
<div class="header d-block row">
  <div class="row block">
    ...
    <div class="text-center col-lg-8 col-sm-12 d-inline pt-2"><h1><strong>Police Verification Reporting System</strong></h1></div>
    <div class="col-lg-2 col-sm-12 d-inline p-5 pt-0 pb-0 text-center"><img src="<?php echo base_url(); ?>/application/views/pics/biswa_bangla_rt.png" alt="Biswa Bangla logo" height="110" width="155"></div>
  </div>
  <div class="mt-5 p-3 m-3 m-xs-0 row">
