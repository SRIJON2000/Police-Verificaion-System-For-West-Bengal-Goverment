    ...
    <div>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto  me-3 me-lg-4 d-flex justify-content-end" >
                 <li><div class="text-white">Logged in as:</div></li><p class="text-white"><b><?php echo $this->session->userdata('user_type')?></b><b>&nbsp(&nbsp<?php echo $this->session->userdata('district_name')?>&nbsp)</b></p>
